...
public class MainView extends JFrame {
   ...
   * 
   * @param timeMgmtView
   *          TimeMgmtView Objekt welches im Tab "Zeiten erfassen" eingesetzt
   *          werden soll
   */
  public void setTimePanel(TimeView timeView) {
    tabbedPaneMain.setComponentAt(0, timeView);
  }
   ...
   * 
   * @param employeeView
   *          EmployeeView Objekt welches im Tab "Mitarbeiter verwalten"
   ...
   * 
   * @return EmployeeView das aktuell eingesetzte "Mitarbeiter verwalten" Panel
   */
  ...
  // Setter und Getter für "Auswertung" muss noch erstellt werden
  // (internerKommentar)
